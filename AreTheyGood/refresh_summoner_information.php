...
if ($hoursSinceSearched >= 3) {
	...
	return Alert ( AlertType::Info, "Please wait at least 3 hours since last update to refresh" );
	exit ();
}
...
$masteriesUpdatedHtml = $masteriesUpdated ? "<div class='mastery-header-update'>Masteries were just updated</div>" : "<div class='mastery-header-update'>Masteries were updated $lastSearched</div>";
