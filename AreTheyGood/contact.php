...
<body>
	<div class="header">
		...
		<div class="header-title">
			<div class="header-links">
				<a href="/">Home</a> <a class="margin-left-20" href="/about.php">About</a>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<form class="js-summoner-name-form" action="send_message.php"
					method="POST">
					<div class="td-form-group">
						<label class="td-form-label">Name (optional)</label> <input
							class="td-form-control" type="text" name="queryName"
							placeholder="Your name" />
					</div>
					<div class="td-form-group">
						<label class="td-form-label">Message</label>
						<textarea class="td-form-control" name="queryMessage"
	...
	<link rel="stylesheet" type="text/css"
		href="/stylesheets/apichallenge.css" media="screen" />
